...
_dingtalkDocsCoolApp.fieldDecoratorKit.setDecorator({
  ...
  execute: function () {
    var _execute = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(context, formItemParams) {
      var modelSelection, inputCommand, refAtt, debugLog, _refAtt$, _initialResult$choice, apiUrl, fileUrl, messages, requestOptions, taskResp, initialResult, _initialResult$error$, aiResult, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            modelSelection = formItemParams.modelSelection, inputCommand = formItemParams.inputCommand, refAtt = formItemParams.refAtt; // 调试日志函数
            ...
            _context.p = 1;
            apiUrl = "http://token.yishangcloud.cn/v1/chat/completions";
            fileUrl = (refAtt === null || refAtt === void 0 || (_refAtt$ = refAtt[0]) === null || _refAtt$ === void 0 ? void 0 : _refAtt$.tmp_url) || ''; // 构建请求消息
            messages = [{
              role: 'user',
              content: [{
                type: 'text',
                text: inputCommand
              }].concat(_toConsumableArray(fileUrl ? [{
                type: 'file_url',
                file_url: {
                  url: fileUrl
                }
