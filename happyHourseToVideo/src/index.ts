...
fieldDecoratorKit.setDecorator({
  ...
  i18nMap: {
    'zh-CN': {
        ...
        'videoPrompt': '视频提示词',
        'refImage': '参考图片',
        'refImageTips': '最多支持1-9张图片，支持 JPG、PNG、 WEBP、BMP、TIFF、GIF，单文件建议小于10MB',
        // 'refVideo': '参考视频',
        ...
        'size': '视频尺寸',
        'sizeTips': '未传入首帧图像：按指定的 ratio 参数生成视频, 传入首帧图像：根据首帧图像的宽高比生成视频',
        'seconds': '视频时长',  
  ...
  formItems: [
    {
      ...
      props: {
        defaultValue: 'happyhorse-1.0',
        placeholder: '请选择模型',
        options: [
          { key: 'happyhorse-1.0', title: 'happyhorse-1.0',},
        ]
      },
      validator: {
        required: true,
